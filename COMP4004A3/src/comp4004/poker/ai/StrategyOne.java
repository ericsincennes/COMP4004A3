...
public class StrategyOne implements Strategy{
	...
	public int runAI(RulesEngine r, BoardState b, long id){
		...
		} else if (h.getStrength().ordinal() < Strength.ThreeOK.ordinal()) {
			return -3;
		//high card case
		} else {
			r.discardCard(2, id);
	...
	public int almostStraight(Hand hand) {
		if (hand.getCardbyIndex(0).getCardValue()+1 == hand.getCardbyIndex(1).getCardValue() && hand.getCardbyIndex(0).getCardValue()+2 == hand.getCardbyIndex(2).getCardValue()
				&& hand.getCardbyIndex(0).getCardValue()+3 == hand.getCardbyIndex(3).getCardValue()) {
			return 4;
		} else if (hand.getCardbyIndex(0).getCardValue()+1 == hand.getCardbyIndex(1).getCardValue() && hand.getCardbyIndex(0).getCardValue()+2 == hand.getCardbyIndex(2).getCardValue()
			...
			return 3;
		} else if (hand.getCardbyIndex(0).getCardValue()+1 == hand.getCardbyIndex(1).getCardValue() && hand.getCardbyIndex(0).getCardValue()+3 == hand.getCardbyIndex(3).getCardValue()
				&& (hand.getCardbyIndex(0).getCardValue()+4 == hand.getCardbyIndex(4).getCardValue() || hand.getCardbyIndex(0).getCardValue()+12 == hand.getCardbyIndex(4).getCardValue())) {
			return 2;
		} else if (hand.getCardbyIndex(0).getCardValue()+2 == hand.getCardbyIndex(2).getCardValue() && hand.getCardbyIndex(0).getCardValue()+3 == hand.getCardbyIndex(3).getCardValue()
				&& (hand.getCardbyIndex(0).getCardValue()+4 == hand.getCardbyIndex(4).getCardValue() || hand.getCardbyIndex(0).getCardValue()+12 == hand.getCardbyIndex(4).getCardValue())) {
			return 1;
		} else if (hand.getCardbyIndex(1).getCardValue()+1 == hand.getCardbyIndex(2).getCardValue() && hand.getCardbyIndex(1).getCardValue()+2 == hand.getCardbyIndex(3).getCardValue()
				&& (hand.getCardbyIndex(1).getCardValue()+3 == hand.getCardbyIndex(4).getCardValue() || hand.getCardbyIndex(1).getCardValue()+11 == hand.getCardbyIndex(4).getCardValue())) {
			return 0;
		}
		return -1;
	}
